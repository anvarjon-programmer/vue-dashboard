      ...
      <div v-else>
        ...
        <div class="mt-6 flex justify-center">
          <button
            ...
            class="bg-gray-300 text-gray-700 px-4 py-2 rounded-l hover:bg-gray-400 transition duration-300"
          >
            Previous
          </button>
          ...
          <button
            ...
            class="bg-gray-300 text-gray-700 px-4 py-2 rounded-r hover:bg-gray-400 transition duration-300"
          >
            Next
          </button>
        </div>
